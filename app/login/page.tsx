...
export default function LoginPage() {
  ...
  const handleGoogleLogin = async () => {
    ...
    setError("Google OAuth coming soon. Use email/password to login.");
  };
    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-background-secondary items-center justify-center border-l border-white/5">
        <div className="max-w-md px-8 text-center">
          <div className="mb-6 inline-flex items-center justify-center w-16 h-16 rounded-full bg-accent-primary/10">
          ...
          <p className="text-foreground-secondary">
            Track your competitors, monitor market trends, and get actionable
